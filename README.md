...
| [docs/case5/SSYLKA_NA_PREZENTACIYU.md](docs/case5/SSYLKA_NA_PREZENTACIYU.md) | **Сюда вставить публичную ссылку** на презентацию для проверки (Google Slides, Диск и т.д.) |
